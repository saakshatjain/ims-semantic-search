...
def process_pending_notices():
    ...
    response = supabase.table("notices_new_2") \
    ...
    for record in response.data:
        ...
        try:
            ...
            try:
                supabase.table("notice_chunks_new_2").delete().eq("notice_id", notice_id).execute()
            except Exception:
                pass
            ...
            for idx, chunk in enumerate(all_chunks):
                ...
                supabase.table("notice_chunks_new_2").insert(row).execute()
